            ...
            public void onClick(View v) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
                    if (ActivityCompat.checkSelfPermission(Localization.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED){
                        if (isGPSEnabled()){
                            LocationServices.getFusedLocationProviderClient(Localization.this)
        ...
        result.addOnCompleteListener(new OnCompleteListener<LocationSettingsResponse>() {
            ...
            public void onComplete(@NonNull Task<LocationSettingsResponse> task) {
                ...
                try {
                    ...
                    Toast.makeText(Localization.this, "GPS is already tured on", Toast.LENGTH_SHORT).show();
                    ...
                    switch (e.getStatusCode()) {
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            ...
                            try {
                                ...
                                resolvableApiException.startResolutionForResult(Localization.this, 2);
